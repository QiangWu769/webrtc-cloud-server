...
class Conductor : public webrtc::PeerConnectionObserver,
 ...
 protected:
  ...
  std::string server_;
  std::unique_ptr<WebRTCConfig> config_;
  std::unique_ptr<VideoFrameWriter> video_frame_writer_;

  // Stats collection for video quality metrics
  bool stats_timer_started_;
  std::unique_ptr<webrtc::TaskQueueBase, webrtc::TaskQueueDeleter> stats_task_queue_;
