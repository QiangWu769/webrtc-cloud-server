...
def main():
    # 修改为你的接收端日志文件路径
    receiver_log_file = '/root/webrtc-checkout/webrtc_config_results/receiver_cloud.log' 
