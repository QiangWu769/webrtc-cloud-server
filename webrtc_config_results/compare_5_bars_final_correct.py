...
"""
最终正确的5柱状图对比 - 淡蓝色和深蓝色
GoogleCC2: 1080p维持20秒 (40s-60s)
Gain2: 1080p维持30秒 (35s-65s)
"""
import matplotlib
matplotlib.use('Agg')
...
data = {
    'GoogleCC2': {
        ...
        'resolution_1080p_duration': 20,  # 40s-60s维持1080p
    },
    'Gain2': {
        'avg_fps': 22.3,
        'avg_qp': 12.3,
        ...
        'resolution_1080p_duration': 30,  # 35s-65s维持1080p
    }
}
...
improvements = {
    ...
    'resolution_1080p_duration': ((data['Gain2']['resolution_1080p_duration'] - data['GoogleCC2']['resolution_1080p_duration']) / data['GoogleCC2']['resolution_1080p_duration']) * 100,
}
...
print("\n" + "="*100)
print("\n*** 重要发现 ***")
print("🎉 Gain2在ALL 5个指标上全面获胜！")
print(f"\n✅ QoE指标:")
print(f"   • FPS: +{improvements['avg_fps']:.1f}%")
print(f"   • QP: +{improvements['avg_qp']:.1f}%")
print(f"   • Freezes: +{improvements['total_freezes']:.1f}%")
print(f"   • Undecodable: +{improvements['total_undecodable']:.1f}%")
print(f"\n✅ 分辨率稳定性:")
print(f"   • 1080p维持时间: +{improvements['resolution_1080p_duration']:.1f}%")
print(f"   • Gain2维持1080p 30秒 vs GoogleCC2仅20秒")
print("\n*** 结论 ***")
print("Gain2配置在所有方面都优于GoogleCC2，强烈推荐使用！")
print("="*100 + "\n")
...
output_path = output_dir / 'comparison_5_bars_accurate.png'
fig.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
print(f"[*] 最终准确的5柱状图已保存到: {output_path}")

output_pdf = output_dir / 'comparison_5_bars_accurate.pdf'
fig.savefig(output_pdf, dpi=300, bbox_inches='tight', format='pdf')
print(f"[*] PDF格式已保存到: {output_pdf}\n")

print("[✓] 分析完成！Gain2在所有5个指标上全面获胜！")
